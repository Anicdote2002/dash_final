...
ipcRenderer.on('updateFault', (event, data) => {
  const { runLO, runHI, postLO, postHI } = data;
  updateFault(runLO, runHI, postLO, postHI);
});

// Example of sending data to the main process
function sendDataToMainProcess(data) {
